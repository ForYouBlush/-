<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" language="java" import="java.sql.*" errorPage="errorpgae.jsp" %>
<html>
<head>
...
%>
<div align="center">
  <p><font color="#FF00" size="+3" face="方正舒体">您所带的班级</font></p>
  <p>&nbsp; </p>

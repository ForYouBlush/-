...
<jsp:useBean id="cla" scope="page" class="Bean.classp"/>
<body style="background:url(1.jpg); " text="#FFFFFF" link="#FF00">
<%
String id="",tea_id="",cour_id="",room_id="",cour_time="",cour_name="",tea_name="";
%>
<div align="center">
  <p><font color="#FF00" size="+3" face="方正舒体">所有班级</font></p>
  <p align="left"><font color="#FF00" size="+1" face="方正舒体"><a href="AddClass.jsp">新增班级</a></font></p>
